      ...
      <div className="max-w-7xl mx-auto px-8 grid lg:grid-cols-2 gap-24 items-center relative z-10">
        ...
        <div>
          ...
          <p className="text-2xl text-gray-600 leading-relaxed max-w-2xl">
            ...
            <br /><br />
            Muchas inmobiliarias inflan el precio para captar clientes y después obligan a bajar el precio.
            <br /><br />
            Nosotros realizamos una valoración basada en datos reales de mercado.
          </p>
        </div>
        ...
        <div>
          <div className="bg-[#FBFAF7] rounded-[45px] p-10 shadow-2xl border border-[#E6DED3]">
            ...
            <div className="flex gap-3 mb-8">
              <span className={`px-4 py-2 rounded-full ${tipo==="venta"?"bg-[#C96E43] text-white":"bg-gray-100 text-gray-700"}`}>Venta</span>
              <span className={`px-4 py-2 rounded-full ${tipo==="alquiler"?"bg-[#C96E43] text-white":"bg-gray-100 text-gray-700"}`}>Alquiler</span>
              <span className={`px-4 py-2 rounded-full ${tipo==="gestion"?"bg-[#C96E43] text-white":"bg-gray-100 text-gray-700"}`}>Gestión</span>
            </div>

            <div className="flex flex-col gap-6">
              <input type="text" placeholder="Nombre" className="p-5 rounded-2xl border border-[#D8D1C5] text-xl outline-none"/>
              <input type="tel" placeholder="Teléfono" className="p-5 rounded-2xl border border-[#D8D1C5] text-xl outline-none"/>
              <input type="email" placeholder="Correo electrónico" className="p-5 rounded-2xl border border-[#D8D1C5] text-xl outline-none"/>
              <input type="text" placeholder="Dirección de la vivienda" className="p-5 rounded-2xl border border-[#D8D1C5] text-xl outline-none"/>
